    ...
    @isset($comic)
        ...
        @else
            ...
            <div class="col-md-8">
                ...
                <input
                    value="{{ $comic->title ??
                        old('title
                                                                                                                                                                                            ') }}"
                    required type="text" name="title" class="form-control" id="input-title" maxlength="255">
            </div>

            {{-- prezzo --}}
            <div class="col-md-4">
                <label for="input-price" class="form-label">Prezzo &euro;</label>
                <input value="{{ $comic->price ?? old('price') }}" required type="number" step="0.01" name="price"
            ...
            <div class="col-md-12">
                ...
                <input value="{{ $comic->description ?? old('description') }}" required type="text" name="description"
            ...
            <div class="col-md-4">
                ...
                <input value="{{ $comic->series ?? old('series') }}" required type="text" name="series"
                    class="form-control" id="input-series">
            </div>
            {{-- type --}}
            <div class="col-md-4">
                <label for="input-type" class="form-label">Tipologia</label>
                <input value="{{ $comic->type ?? old('type') }}" required type="text" name="type" class="form-control"
                    id="input-type">
            </div>
            {{-- sale_date --}}
            <div class="col-md-4">
                <label for="input-sale_date" class="form-label">Data di pubblicazione</label>
                <input value="{{ $comic->sale_date ?? old('sale_date') }}" required type="date" name="sale_date"
                    class="form-control" id="input-sale_date">
            </div>
            {{-- artists --}}
            <div class="col-md-6">
                <label for="input-artists" class="form-label">Artisti</label>
                <input value="{{ $comic->artists ?? old('artists') }}" required type="text" name="artists"
                    class="form-control" id="input-artists">
            </div>
            {{-- writers --}}
            <div class="col-md-6">
                <label for="input-writers" class="form-label">Scrittori</label>
                <input value="{{ $comic->writers ?? old('writers') }}" required type="text" name="writers"
                    class="form-control" id="input-writers">
            </div>
            {{-- thumb --}}
            <div class="col-md-12">
                <label for="input-thumb" class="form-label">Immagine di copertina</label>
                <input value="{{ $comic->thumb ?? old('thumb') }}" required type="text" name="thumb"
                    class="form-control" id="input-thumb">
            </div>
